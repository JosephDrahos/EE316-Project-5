...
-- Date        : Thu Apr 15 14:08:19 2021
-- Host        : LAPTOP-P7H4SB08 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/15184/Documents/Clarkson_Docs/EE316/project_5.1/project_5.1.srcs/sources_1/bd/design_1/ip/design_1_Custom_PWM_0_0/design_1_Custom_PWM_0_0_sim_netlist.vhdl
...
entity design_1_Custom_PWM_0_0_motor_pwm is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_Custom_PWM_0_0_motor_pwm : entity is "motor_pwm";
end design_1_Custom_PWM_0_0_motor_pwm;

architecture STRUCTURE of design_1_Custom_PWM_0_0_motor_pwm is
  ...
  signal \leqOp_carry__1_i_3_n_0\ : STD_LOGIC;
  signal \leqOp_carry__1_i_4_n_0\ : STD_LOGIC;
  signal \leqOp_carry__1_i_5_n_0\ : STD_LOGIC;
  signal \leqOp_carry__1_i_6_n_0\ : STD_LOGIC;
  signal \leqOp_carry__1_i_7_n_0\ : STD_LOGIC;
  signal \leqOp_carry__1_i_8_n_0\ : STD_LOGIC;
...
\leqOp_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \leqOp_carry__1_i_1_n_0\,
      DI(2) => \leqOp_carry__1_i_2_n_0\,
      DI(1) => \leqOp_carry__1_i_3_n_0\,
      DI(0) => \leqOp_carry__1_i_4_n_0\,
      O(3 downto 0) => \NLW_leqOp_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \leqOp_carry__1_i_5_n_0\,
      S(2) => \leqOp_carry__1_i_6_n_0\,
      S(1) => \leqOp_carry__1_i_7_n_0\,
      S(0) => \leqOp_carry__1_i_8_n_0\
    );
\leqOp_carry__1_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
...
\leqOp_carry__1_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
...
\leqOp_carry__1_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => counter_reg(19),
      I3 => s00_axi_wdata(19),
      O => \leqOp_carry__1_i_3_n_0\
    );
\leqOp_carry__1_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
      ...
      I2 => counter_reg(17),
      I3 => s00_axi_wdata(17),
      O => \leqOp_carry__1_i_4_n_0\
    );
\leqOp_carry__1_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => s00_axi_wdata(23),
      I3 => counter_reg(23),
      O => \leqOp_carry__1_i_5_n_0\
    );
\leqOp_carry__1_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => s00_axi_wdata(21),
      I3 => counter_reg(21),
      O => \leqOp_carry__1_i_6_n_0\
    );
\leqOp_carry__1_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
      ...
      I2 => s00_axi_wdata(19),
      I3 => counter_reg(19),
      O => \leqOp_carry__1_i_7_n_0\
    );
\leqOp_carry__1_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_Custom_PWM_0_0_Custom_PWM_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_Custom_PWM_0_0_Custom_PWM_v1_0_S00_AXI : entity is "Custom_PWM_v1_0_S00_AXI";
end design_1_Custom_PWM_0_0_Custom_PWM_v1_0_S00_AXI;

architecture STRUCTURE of design_1_Custom_PWM_0_0_Custom_PWM_v1_0_S00_AXI is
...
motor_pwm_inst1: entity work.design_1_Custom_PWM_0_0_motor_pwm
     port map (
      o_data => o_data,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_Custom_PWM_0_0_Custom_PWM_v1_0 is
  port (
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_Custom_PWM_0_0_Custom_PWM_v1_0 : entity is "Custom_PWM_v1_0";
end design_1_Custom_PWM_0_0_Custom_PWM_v1_0;

architecture STRUCTURE of design_1_Custom_PWM_0_0_Custom_PWM_v1_0 is
begin
Custom_PWM_v1_0_S00_AXI_inst: entity work.design_1_Custom_PWM_0_0_Custom_PWM_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
entity design_1_Custom_PWM_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_Custom_PWM_0_0 : entity is "design_1_Custom_PWM_0_0,Custom_PWM_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_Custom_PWM_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_Custom_PWM_0_0 : entity is "Custom_PWM_v1_0,Vivado 2019.1";
...
U0: entity work.design_1_Custom_PWM_0_0_Custom_PWM_v1_0
     port map (
